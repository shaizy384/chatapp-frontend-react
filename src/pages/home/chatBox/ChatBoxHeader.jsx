...
const ChatBoxHeader = () => {
    ...
    return (
        <>
            <div className="flex justify-between gap-x-6 py-6 sm:px-5 px-4 border-b rounded-t-2xl bg-white">
                <div className="flex items-center min-w-0 gap-x-4">
                    ...
                    <div className="min-w-0 flex-auto">
                        <p className="text-lg sm:text-xl font-semibold leading-6 text-gray-900">Shahzaib Qasim</p>
                        <p className="truncate text-md leading-5 text-sky-600">typing...</p>
                    </div>
                </div>
